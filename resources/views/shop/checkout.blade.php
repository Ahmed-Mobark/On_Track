...
<script>
const egyptData = {
    'القاهرة': ['مدينة نصر','المعادي','مصر الجديدة','التجمع الخامس','الشروق','العبور','بدر','15 مايو','حلوان','المقطم','عين شمس','شبرا','الزيتون','المطرية','دار السلام','البساتين','السيدة زينب','وسط البلد','الزمالك','جاردن سيتي','المنيل','الدقي','العجوزة'],
    'الجيزة': ['الدقي','المهندسين','العجوزة','فيصل','الهرم','6 أكتوبر','الشيخ زايد','حدائق الأهرام','أبو النمرس','العياط','البدرشين','الصف','أطفيح','الحوامدية','كرداسة'],
    'الإسكندرية': ['المنتزه','شرق','وسط','غرب','العامرية','الجمرك','العطارين','محرم بك','سيدي بشر','ستانلي','سموحة','كليوباترا','لوران','جليم','سان ستيفانو','أبو قير','برج العرب'],
    'القليوبية': ['بنها','شبرا الخيمة','قليوب','الخانكة','القناطر الخيرية','طوخ','كفر شكر','شبين القناطر','الخصوص','العبور'],
    'الشرقية': ['الزقازيق','العاشر من رمضان','بلبيس','منيا القمح','أبو حماد','أبو كبير','فاقوس','ههيا','ديرب نجم','الحسينية','أولاد صقر','كفر صقر','مشتول السوق'],
    'الدقهلية': ['المنصورة','طلخا','ميت غمر','دكرنس','أجا','السنبلاوين','المنزلة','شربين','تمي الأمديد','بلقاس','منية النصر','الجمالية','بني عبيد','نبروه'],
    'البحيرة': ['دمنهور','كفر الدوار','رشيد','إدكو','أبو حمص','حوش عيسى','الدلنجات','المحمودية','الرحمانية','إيتاي البارود','شبراخيت','كوم حمادة','وادي النطرون'],
    'الغربية': ['طنطا','المحلة الكبرى','كفر الزيات','زفتى','السنطة','سمنود','بسيون','قطور'],
    'المنوفية': ['شبين الكوم','مدينة السادات','منوف','أشمون','الباجور','تلا','بركة السبع','قويسنا','الشهداء'],
    ...
    'المنيا': ['المنيا','ملوي','سمالوط','المنيا الجديدة','بني مزار','مطاي','أبو قرقاص','دير مواس','العدوة','مغاغة'],
    'أسيوط': ['أسيوط','أسيوط الجديدة','ديروط','القوصية','منفلوط','أبنوب','الفتح','ساحل سليم','أبو تيج','الغنايم','البداري'],
    'سوهاج': ['سوهاج','سوهاج الجديدة','أخميم','طهطا','جرجا','المنشأة','البلينا','المراغة','دار السلام','ساقلتة','طما','جهينة'],
